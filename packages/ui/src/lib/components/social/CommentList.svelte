			...
			<div class="group">
				<div class="flex items-start gap-2">
					<Avatar class="size-7 shrink-0 mt-0.5">
						<AvatarFallback class="bg-purple-100 dark:bg-purple-900 text-[10px] font-medium text-purple-600 dark:text-purple-300">{comment.user_id.charAt(0).toUpperCase()}</AvatarFallback>
					</Avatar>
